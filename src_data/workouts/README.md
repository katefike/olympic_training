# Source Data
This directory contains all the data used for this project. The HEIC
files are pictures of my workout journal pages. Using openai, I
converted them to JSON files in `/training_set`
